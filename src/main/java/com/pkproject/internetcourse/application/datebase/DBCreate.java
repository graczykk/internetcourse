    ...
    public void createDB() throws SQLException {
        ...
        try {
            ...
            query = "CREATE TABLE IF NOT EXISTS `internetcourse`.`Pytanie` \n" +
                    ...
                    "\t`idTest` INT NOT NULL ,\n" +
                    "\t`tresc` TEXT(100) NOT NULL , \n" +
                    "\t`odpowiedza` TEXT(100) NOT NULL , \n" +
                    "\t`odpowiedzb` TEXT(100) NOT NULL ,\n" +
                    "\t`odpowiedzc`TEXT(100) NOT NULL ,\n" +
                    "\t`odpowiedzd` TEXT(100) NOT NULL ,\n" +
                    "\t`prawidlowaOdpowiedz` TEXT(45) NOT NULL ,\n" +
